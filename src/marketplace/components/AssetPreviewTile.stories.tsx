...
export const PlateBottomChip: Story = {
  render: () => <AssetPreviewTile rarity="mythic" figure="plate" chipPosition="bottom" />,
};

export const InsetNoChip: Story = {
  render: () => <AssetPreviewTile rarity="epic" figure="inset" label={null} />,
};
...
export const SmallModalImage: Story = {
  render: () => (
...
export const AllRarities: Story = {
  render: () => (
    <div style={{ display: "flex", flexWrap: "wrap", gap: 16 }}>
      {(["common", "uncommon", "rare", "epic", "legendary", "mythic", "unique", "exotic"] as const).map(
        (r) => (
          <AssetPreviewTile
            key={r}
            rarity={r}

  ...
  return (
    <FlowMapPage
      ...
      copy={{
        ...
        lede: (
          <>
            The complete click/state sitemap of the Explorer — the decentraland.org/play web
        ...
        honesty: (
          <>
            Source of truth: the overlay sources under <code>ui3/src/app</code>,{" "}
            <code>ui3/src/explorer</code> and <code>ui3/src/overlay</code>, plus the
            engine page <code>bevy-explorer/deploy/web/index.html</code>; every bridge
            claim checked against <code>ui3/src/generated/bridge/BridgeAction.ts</code>.

          ...
          {scene.editable ? (
              ...
              {scene.kind === "land" && scene.republishable !== false && onRepublish ? (
                <>
                  ...
                  <span className="chms__note">
                    ...
                    network (decentraland.org) only — Genesis City on decentraland.org is not
                    affected. Your wallet&apos;s LAND rights are checked before publish.
                  </span>
                </>
              ) : scene.kind === "land" ? (
                <span className="chms__note">
                  Publishing from here updates this network (decentraland.org) only, never
            ...
            <div className="chms__viewonly">
              ...
              <span className="chms__note">
                ...
                {scene.kind === "land"
                  ? " Republishing updates this network (decentraland.org) only — Genesis City on decentraland.org is not affected."
                  : ""}
              </span>
            </div>
          )}

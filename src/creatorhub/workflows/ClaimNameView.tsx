import MkClaimNamePage from "../../marketplace/pages/MkClaimNamePage";
import MkSuccessPage from "../../marketplace/pages/MkSuccessPage";
import ChPublishWizardPublishToWorld from "./ChPublishWizardPublishToWorld";
import AssetActionLayout from "../../marketplace/frames/AssetActionLayout";
import Button from "../../atoms/Button";
import ManaMark from "../../atoms/ManaMark";
import "./claimnameview.css";

type ClaimNameViewProps = {
  view?: string;
  step?: string;
  name?: string;
  worldName?: string;

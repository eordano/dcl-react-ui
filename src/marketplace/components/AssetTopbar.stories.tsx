...
} satisfies Meta<typeof AssetTopbar>;
...
export const CollectiblesInline: Story = {
  render: () => {
...
export const LandStacked: Story = {
  render: () => {
...
export const SearchAndCountOnly: Story = {
  render: () => <AssetTopbar searchPlaceholder="Search" count={248} />,
};

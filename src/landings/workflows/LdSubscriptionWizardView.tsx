      ...
      <div className="subscription-wizard" data-step={step}>
        ...
        {value === "submitting" && (
          <section className="subscription-wizard__progress" role="status" aria-busy="true">
            ...
            <p>Updating your email notification preferences (simulated commit).</p>
          </section>
        )}
        ...
        {value === "unsubscribing" && (
          <section className="subscription-wizard__progress" role="status" aria-busy="true">
            <h1>Unsubscribing…</h1>
            <p>Turning off your event email notifications (simulated commit).</p>
          </section>
        )}

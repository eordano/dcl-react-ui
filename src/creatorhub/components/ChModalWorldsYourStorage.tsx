...
export default function ChModalWorldsYourStorage({
  ...
  const card = (
    <>
      <h5 className="chmodalworldsyourstorage__title" id="chwys-title">
        {COPY.yourStorage}
      </h5>
  ...
  return embedded ? (
    ...
    <CreatorHubChrome active="manage">{surface}</CreatorHubChrome>
  );
}

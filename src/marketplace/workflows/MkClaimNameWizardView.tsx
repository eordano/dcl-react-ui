    ...
    <div className="claim-name-wizard" data-step={step}>
      ...
      {value === "approving" && (
        <AssetActionLayout
          ...
          warning="Test mode — this approval is simulated: no transaction is sent and no MANA leaves your wallet."
          onBack={onBack}
        >
      ...
      {value === "confirming" && (
        <AssetActionLayout
          ...
          warning="Test mode — this mint is simulated: no NAME will actually be registered and nothing will be charged."
          onBack={onBack}
        >
          <div className="claim-name-wizard__controls">

  ...
  return (
    <GovernanceChrome active="proposals" account={account.short} signedIn={loggedIn} onTab={onTab}>
      <div className="submit-draft-wizard" data-step={step} data-source={source}>
        ...
        {value === "intro" && (
          <section className="submit-draft-wizard__intro" aria-label="Draft proposal — start">
        ...
        {value === "coauthors" && (
          <section className="submit-draft-wizard__coauthors" aria-label="Draft proposal — co-authors">
        ...
        {value === "review" && (
          <section className="submit-draft-wizard__review" aria-label="Draft proposal — review">
        ...
        {value === "success" && (
          <section className="submit-draft-wizard__success" aria-label="Draft proposal — success">

...
type Photo = { id: string; grad: string; metadata: PhotoMetadata };
...
type StProfilePhotosTabProps = { isOwnProfile?: boolean; photos?: Photo[] };

export default function StProfilePhotosTab({ isOwnProfile = false, photos = PHOTOS }: StProfilePhotosTabProps) {

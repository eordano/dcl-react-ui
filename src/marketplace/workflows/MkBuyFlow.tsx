...
export default function MkBuyFlow({
  ...
  if (showCard) {
    return (
      <Modal width={440} className="modal__card--plain mkbuyflow__modal mkbuyflow__modal--card" ariaLabel="Buy with card">
  ...
  return (
    <Modal width={440} className="modal__card--plain mkbuyflow__modal" ariaLabel="Confirm Your Purchase">
        <nav className="mkbuyflow__nav">
          {!isBuying ? (

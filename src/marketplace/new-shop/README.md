...
ui3 component family ported from the Figma file Marketplace UX Improvements (`Z0actRbZof0tDolIdxIL3A`, node `744-53267`, page Preview / flagship frame `1000001575`). Structure and layout kept faithful; restyled onto ui3's dark, tokenized surfaces (`--lm-*`, `--rar-*`, `--accent`, `--brand`) - the same divergence NftCard and the rest of `marketplace/` already use. Plain JSX + CSS, no new dependencies.
## Components
...
| `NewShopHome` | page - tabs + banner pair + featured rows + rank table | Frame 1000001575 |

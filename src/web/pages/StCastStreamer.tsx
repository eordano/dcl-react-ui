            ...
            <div className="stcast__main">
              ...
              <div className="stcast__controls">
                <div className="stcast__center">
                  <CircleControl glyph={<MicGlyph size={24} fill="#16141a" />} label="Microphone" withChevron />
                  <CircleControl glyph={<VideocamGlyph size={24} fill="#16141a" />} label="Camera" withChevron />
                  <CircleControl glyph={<ScreenShareGlyph size={24} fill="#16141a" />} label="Share screen" withChevron />

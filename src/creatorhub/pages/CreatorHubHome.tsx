...
const EXPLORE_LINKS: ExploreLink[] = [
  ...
  { title: "Deploy a scene", href: "/creator-hub/deploy-world", icon: <DeployIcon /> },
...
const MANAGE_LINKS: ManageLink[] = [
  ...
  { title: "Land", href: "https://builder.decentraland.org/land", icon: <LandIcon />, builder: true },
  { title: "Names", href: "https://builder.decentraland.org/names", icon: <NamesIcon />, builder: true },
];
...
export default function CreatorHubHome({
  ...
  return (
    <CreatorHubChrome active="home" signedIn={signedIn} account={account} name={name} committee={committee} onSignIn={onSignIn}>
      <section className="chh">
        <div className="chh__container">
          ...
          <div className={hasScenes ? "chh__grid" : "chh__grid chh__grid--duo"}>
            ...
            {hasScenes ? <ManageCard committee={committee} /> : null}

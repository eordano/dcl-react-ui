...
function ReferralJourney({ invitedUsersAccepted }: { invitedUsersAccepted: number }) {
  ...
  return (
    <section className={`${C}__journey`}>
      ...
      <div className={`${C}__jscroll`} role="region" aria-label="Your Reward Journey" tabIndex={0}>
...
type StProfileReferralRewardsTabProps = {

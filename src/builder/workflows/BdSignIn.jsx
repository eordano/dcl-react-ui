...
export default function BdSignIn({
  isConnecting = false,
  isConnected = false,
  hasError = false,
}) {
  ...
  return (
    <BuilderChrome account="">
      <div className="bdsignin">
        <div className="bdsignin__card">
          <h1 className="bdsignin__header">Get Started</h1>

          <div className="bdsignin__icon">
            <StarWalletIcon />
          </div>

          <p className="bdsignin__message">
            <DesktopMessage />
          </p>

          <button
            type="button"
            className="bdsignin__button"
            disabled={disabled}
          >
            {label}
          </button>
          ...
          <p
            className={
              "bdsignin__error" + (errorVisible ? " is-visible" : "")
            }
          >
          ...
          {isConnecting && (
            <div className="bdsignin__redirect" role="status">
              <span className="bdsignin__spinner" aria-hidden="true" />
              Redirecting you to connect your wallet…
            </div>
          )}
        </div>
      </div>

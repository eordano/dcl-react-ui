...
function SelectWorld({ data, multiScene, onToggleMulti, onPickName, onReview, onClaimName }: SelectWorldProps) {
  ...
  return (
    <div className="cpw__empty">
      ...
      <p className="cpw__emptybody">
        ...
        NAME you own comes with a free World.
      </p>
...
function EmptyNames({ onClaimName }: { onClaimName?: () => void }) {
  return (
    <div className="cpw__empty">
  ...
  const panel = (
    ...
    >
      ...
      <div className="cpw__body">
        {isSignedOut ? (
          <SignedOutGate onSignIn={onSignIn} onClaimName={onClaimName} />
        ) : isEmpty ? (
          pendingName ? (

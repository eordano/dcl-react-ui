  ...
  return (
    <FlowMapPage
      ...
      copy={{
        ...
        machineTitle: (m) => `sites/app/stories/creator-hub/${m}/machine.ts`,
        asciiLabel: "Creator Hub sitemap, ascii original",
        honesty: (
          <>
            Source of truth: the route files under{" "}
            <code>sites/app/routes/create.*.tsx</code> and{" "}
            <code>sites/app/routes/creator-hub.*.tsx</code> · machine states from{" "}
            <code>sites/app/stories/creator-hub/*/machine.ts</code>. Redirect shims

  ...
  return (
    <div className="sa" data-step={step}>
      <header className="sa__head">
        ...
        <p className="sa__sub">
          Grant or revoke who may administer a place you operate. Changes are{" "}
          <strong>simulated</strong> here — the live commit is signed-fetch gated.
        </p>
        ...
        {view === "confirm" && (
          <div className="sa-confirm">
            ...
            <p className="sa-confirm__sim">
              {action === "revoke"
                ? "Simulates DELETE /scene-admin?place_id=…&admin=…"
                : "Simulates POST /scene-admin { place_id, admin }"}{" "}
              — the live endpoint is is_scene_owner_or_admin gated (403 for an
              anonymous browser).
            </p>
            {error && (
        ...
        {view === "done" && (
          <div className="sa-done" role="status">
            ...
            <h2 className="sa-done__title">
              ...
              <span className="sa-done__sim">(simulated)</span>
            </h2>

...
export const PRIMARY_MINT_NOTE =
  "Make an offer to buy this item — it's a new mint sold by its creator, and Credits checkout doesn't support new mints yet.";
export const CREDITS_UNAVAILABLE_NOTE =
  "Direct checkout isn't available for this item right now — use a listing below to buy a specific copy.";

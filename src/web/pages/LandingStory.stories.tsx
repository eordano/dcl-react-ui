...
export const SceneCreators: Story = {
  render: () => (
    <LandingStory
      ...
      subhead="Build a 3D world people show up for — open, yours, and unkillable."
      beats={[
...
export const Players: Story = {
  render: () => (
    <LandingStory
      ...
      subhead="Drop into live events, games, and rooms full of real people — no download, just a link."
      beats={[
        { title: "Something's on right now", body: "Parties, tournaments, openings — not an empty map to wander." },
        { title: "Your look is the opener", body: "Your avatar, your style, your expression — the fun starts before the game does." },

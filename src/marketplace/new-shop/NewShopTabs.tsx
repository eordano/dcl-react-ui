...
export type NewShopTab = { id: string; label: string; href?: string };

export const NEW_SHOP_TABS: NewShopTab[] = [
...
export default function NewShopTabs({
  tabs = NEW_SHOP_TABS,
  active = "overview",
  onTab,

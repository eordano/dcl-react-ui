...
const counter = (current: number, limit: number) => `(${current} out of ${limit} characters)`;
...
function LoginGate({ onTab }: { onTab?: (id: string) => void }) {
  return (
...
function LoadingGate({ onTab }: { onTab?: (id: string) => void }) {
  return (

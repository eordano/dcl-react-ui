...
function ConfirmDialog({
  ...
  if (!open) return null;
  return (
    <Modal onClose={onCancel} width="100%" className="modal__card--plain ststp__dialog" ariaLabelledBy="ststp-dialog-title">
...
export default function StStoragePlayers({
  ...
  return embedded ? body : <SitesChrome active="create">{body}</SitesChrome>;
}

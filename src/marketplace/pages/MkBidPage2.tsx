...
import MarketplaceChrome from "../frames/MarketplaceChrome";
...
function ConfirmModal({ item, price, onCancel, loading }: ConfirmModalProps) {
  return (
    <Modal width="100%" className="modal__card--plain mkbidpage2__dialog" ariaLabel="Please confirm">

      ...
      <div className="rsvp-wizard__panel" role="group" aria-label="RSVP to this event">
        ...
        {value === "signinGate" && (
          <>
            <p className="rsvp-wizard__hint">
              Sign in to RSVP. (The wallet signature is simulated in this demo.)
            </p>
            <div className="rsvp-wizard__row">
              <Button variant="secondary" onClick={onCancel}>
                Cancel
              </Button>
              <Button onClick={onSignIn}>Sign in (simulated)</Button>
            </div>
          </>
        )}
        ...
        {value === "submitting" && (
          <p className="rsvp-wizard__hint" aria-busy="true">
            Submitting your RSVP… (simulated authenticated write)
          </p>
        )}
        ...
        {value === "cancelling" && (
          <p className="rsvp-wizard__hint" aria-busy="true">
            Cancelling your RSVP… (simulated authenticated delete)
          </p>
        )}

...
export type RarityVars = CSSProperties & { "--r": string; "--rb": string };

export const rarityColor = (r: string): string => `var(--rar-${r})`;
export const rarityBg = (r: string): string => `var(--rar-bg-${r})`;
export const rarityVars = (r: string): RarityVars => ({ "--r": rarityColor(r), "--rb": rarityBg(r) });

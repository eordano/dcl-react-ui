            ...
            <div className="mp-report__card">
              ...
              <span className="mp-report__card-unit">
                ms{report.convergeP95Ms !== null
                  ? ` · p95 ${Math.round(report.convergeP95Ms)} ms`
                  : ""}
              </span>
            </div>
            <div className="mp-report__card">
                ...
                {divergence.length === 0 ? (
                  ...
                  divergence.map((d, i) => (
                    ...
                    >
                      ...
                      <td>{d.component}</td>
                      <td>{d.peers.join(", ") || "—"}</td>
                      <td className="mp-report__hash">{d.oracle ?? "—"}</td>
                      <td className="mp-report__hash">{d.beacon ?? "—"}</td>
                      <td className="mp-report__hash">{d.probe ?? "—"}</td>
                      <td>
                        {d.closed === null ? "—" : d.closed ? "closed" : "open at end"}
                      </td>
                    </tr>
                  ))
                )}
